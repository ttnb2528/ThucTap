...
const Slider = () => {
  ...
  return (
    <div className="slider basis-1/6 flex flex-col pt-8 w-full max-w-[300px] h-auto min-h-[100vh] bg-neutral-100">
      <Collapse
        key={items.key}
        onChange={onChange}
        items={items}
